...
<body>
	...
	<h3>
		<a href="mvc?servico=MostraImovelServico">Cadatrar im&oacute;vel</a>
	</h3>
	<table cellspacing="2" width="70%">
		...
		<c:forEach var="imovel" items="${imoveis}" varStatus="ln">
			<tr bgcolor="#${ln.count % 2 == 0 ? '9c9c9c' : 'ffffff'}">
				...
				<td><a class="remover" href="#" id="${imovel.id}">Remover</a></td>

				<td><a href="mvc?servico=MostraImovelServico&id=${imovel.id}">Alterar</a>
				</td>
	...
	<script>
		$('.remover').click(
				function() {
					...
					if (r) {
						window.open('mvc?servico=RemoveImovelServico&id='
								+ $(this).attr('id'), '_self');
					}
				});
	</script>
